...
<head>
	<meta charset="UTF-8">
	<title>Sistem kegunaan truck Dengan Metode AHP</title>
	<link rel="stylesheet" type="text/css" href="css/style.css">
	<link rel="stylesheet" type="text/css" href="semantic/dist/semantic.min.css">
</head>

<body>
<header style="background-color:#5499C7">
	<h1>Sistem kegunaan truck Dengan Metode AHP</h1>
</header>

<div class="wrapper">
	<nav id="navigation" role="navigation" style="background-color:#1B4F72;">
		<ul>
